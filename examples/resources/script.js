...
class CustomView extends View {
  constructor (d3el) {
    super(d3el, [
      // Can load plain text
      { name: 'template', type: 'text', url: 'template.html', then: data => { console.log('loaded template', data); } },
      // Can load data via d3.js
      { name: 'CSV data', type: 'csv', url: 'data.csv', then: data => { console.log('loaded csv', data); } },
      // Can load CSS
